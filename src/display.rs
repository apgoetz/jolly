...
use iced_native::{widget, event, renderer, layout, text, mouse, keyboard};
use std::hash::Hash;
use crate::store;
    ...
    where Renderer: text::Renderer
{
	...
	match event {
	    ...
	    event::Event::Keyboard(keyboard::Event::KeyReleased{key_code : code, modifiers:_}) => {

use iced_native::{text,widget, keyboard};
...
where  {
	...
	let code = match event {
	    keyboard::Event::KeyPressed{key_code: code, modifiers: _} => code,
	    _ => return
	};
    ...
    pub fn view<'a, F, Message, Renderer>(&'a self, f : F) -> iced_native::Element<'a, Message, Renderer>
    where F: 'static + Fn(store::StoreEntry) -> Message,
